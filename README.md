...
*Здесь нет железных правил. Это стилевые предпочтения, а не религиозные догмы.* :wink:
...
## **7. Используйте понятные имена переменных и функций** :+1:
---
...
## **10. Подумайте об использований правил Сэнди Метц** :+1:
